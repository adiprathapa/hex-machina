...
export function createClockworkOrchardScenario(): SpellGraph {
  return {
    ...
    nodes: [
      ...
      { id: "hasten", kind: "modifier", label: "Hasten", glyph: "»", description: "Advances the next action before its natural time.", x: 27, y: 23 },
      ...
      { id: "closed-bloom", kind: "target", label: "Closed bloom", glyph: "◉", description: "A fragile orchid bud that cannot yet receive pollen.", x: 88, y: 17 },
      ...
      { id: "seed-song", kind: "sink", label: "Seed song", glyph: "♩", description: "The desired fertile terminal state.", x: 70, y: 84, dormant: true },
      ...
      { id: "moon-cactus", kind: "target", label: "Moon cactus", glyph: "♧", description: "A hardy but irrelevant nocturnal plant.", x: 89, y: 88, dormant: true },
      { id: "at-midnight", kind: "condition", label: "At midnight", glyph: "◐", description: "A tempting but incorrect timing guard.", x: 8, y: 13, dormant: true },
      { id: "scatter", kind: "verb", label: "Scatter", glyph: "⋰", description: "Disperses pollen without selecting a viable bloom.", x: 69, y: 11, dormant: true },
    ],
    edges: [
