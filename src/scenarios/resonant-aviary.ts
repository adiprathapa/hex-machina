...
export function createResonantAviaryScenario(options: ScenarioLayoutOptions = {}): SpellGraph {
  const graph: SpellGraph = {
    ...
    nodes: [
      ...
      { id: "echo", kind: "modifier", label: "Echo", glyph: "∞", description: "Feeds a received song back into its singer.", x: 30, y: 26 },
      ...
      { id: "glass-dome", kind: "target", label: "Glass dome", glyph: "◯", description: "A fragile dome around the aviary.", x: 88, y: 24 },
      ...
      { id: "harmony", kind: "sink", label: "Harmony", glyph: "✧", description: "The desired stable terminal state.", x: 68, y: 75, dormant: true },
      ...
      { id: "weather-vane", kind: "target", label: "Weather vane", glyph: "⌖", description: "A grounded decoy target.", x: 90, y: 89, dormant: true },
      { id: "dawn", kind: "condition", label: "At dawn", glyph: "☼", description: "A dormant timing condition.", x: 8, y: 9, dormant: true },
      { id: "release", kind: "verb", label: "Release", glyph: "⇡", description: "Lets a chord dissipate without selecting a destination.", x: 66, y: 9, dormant: true },
    ],
    edges: [
