...
`submission/demo-script.md` remains the concise 75-second storyboard; the final screencast is longer because it shows real tool execution and a second held-out family. Keep `captions.srt` with the MP4 when uploading to any submission platform that accepts caption files.
